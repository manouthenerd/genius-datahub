...
<template>
    <AuthBase title="Connectez-vous à votre espace" description="Remplissez les champs ci-dessous pour vous connecter">
        ...
        <Form method="post" :action="route('login')" :reset-on-success="['password']" v-slot="{ errors, processing }" class="flex flex-col gap-6">
            <div class="grid gap-6 rounded-sm bg-blue-100 p-2">
                ...
                <Button type="submit" class="mt-4 w-full bg-[#0168a6] hover:bg-[#0168a6] hover:opacity-80" :tabindex="4" :disabled="processing">
