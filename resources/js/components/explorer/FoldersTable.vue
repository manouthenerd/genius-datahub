<template>
    <table class="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
        ...
        <tbody v-if="folders.length">
            <tr>
                <th scope="row"
                    class="px-6 py-2 font-medium text-gray-900 whitespace-nowrap dark:text-white flex items-center gap-1 cursor-pointer">
                    <Link href="/dashboard">
            ...
            <tr v-for="folder in folders" :key="folder.id"
                class="border-y transition-all dark:bg-gray-800 dark:border-gray-700 border-gray-200">
                <th scope="row"
                    class="px-6 py-2 font-medium text-gray-900 whitespace-nowrap dark:text-white cursor-pointer">
                    <ContextMenu>
                        <ContextMenuTrigger>
        ...
        <tbody v-else class="w-full space-y-2">
            ...
            <tr>
                <th colspan="5" class="text-center">
                    <p class="w-full mt-4 text-black text-sm text-center p-2 underline">Aucun dossier
                        trouvé.
                    </p>
                </th>
            </tr>
...
import { Folder, Ellipsis, FolderPen, Trash } from 'lucide-vue-next';
