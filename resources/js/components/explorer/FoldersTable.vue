    ...
    <table class="w-full text-left text-sm text-gray-500 rtl:text-right dark:text-gray-400">
                ...
                <th scope="col" class="px-6 py-3">
                    <Popover v-model:open="open">
                        ...
                        <PopoverContent>
                            ...
                            <Form method="POST" :action="route('folders.store', { service: service.id })"
                                :reset-on-success="['name']" @success="closePopover" v-slot="{ errors, processing }" class="grid gap-2">
        ...
        <tbody v-if="folders.length">
            ...
            <tr v-for="folder in folders" :key="folder.id"
                ...
                <th scope="row"
                    class="cursor-pointer px-6 py-2 font-medium whitespace-nowrap text-gray-900 dark:text-white">
                    <ContextMenu>
                        <ContextMenuTrigger>
                            <Link :href="route('resources.files', { service: service.id, folder: folder.id })"
                        ...
                        <ContextMenuContent>
                            <ContextMenuSub>
                                ...
                                <ContextMenuSubContent v-if="showContext">
                                    <Form @success="updateContextState" class="grid gap-2" method="PUT"
                                        ...
                                        <Input type="text" name="name" :modelValue="folder.name"
                            ...
                            <ContextMenuItem>
                                <Form method="DELETE" :action="route('folders.destroy', { folder: folder.id })">
                                    <Button style="color: red" variant="link">
